...
const Cart = ({ route, navigation }) => {
  ...
  const handlePressCheckout = () => {
    if (cartItems.length === 0) {
      ...
      navigation.navigate('Checkout', { cartItems, setCartItems });
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.removeAllButtonText}>Delete All</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.thanhToanButton} onPress={handlePressCheckout}>
        <Text style={styles.thanhToanButtonText}>Checkout</Text>
      </TouchableOpacity>
      </View>
    </View>
  );
